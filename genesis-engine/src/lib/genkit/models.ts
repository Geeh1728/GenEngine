 ...
 * Optimized for 2026 Google AI Studio & Groq Limits.
 */

export const MODELS = {
    // ELITE THINKERS (PhD-Level Reasoning)
    BRAIN_ELITE: 'googleai/gemini-3-pro',             // 1.5K RPD
    BRAIN_PRO: 'googleai/gemini-2.0-pro-exp-02-05',    // 1.5K RPD
    ...
    BRAIN_FLASH_20: 'googleai/gemini-2.0-flash',       // 1.5K RPD
    BRAIN_FLASH_20_EXP: 'googleai/gemini-2.0-flash-exp', // 1.5K RPD
    
    // SCALE & BULK (High-Throughput / High-RPD)
    BRAIN_LITE: 'googleai/gemini-2.0-flash-lite',      // 1.5K RPD
